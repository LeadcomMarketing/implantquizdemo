...
function HappidentQuizPageInner() {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      <SiteHeader phase={quiz.phase} onOpenModal={() => handleOpenModal('header')} />
          ...
          <div className="max-w-[760px] mx-auto w-full">
            ...
            <div className="flex flex-wrap gap-2 justify-center mt-5 max-w-[640px] mx-auto">
              <span className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-ink bg-surface border border-border py-2 px-3.5 rounded-full" style={{ boxShadow: 'var(--shadow)' }}>
                <span className="text-gold-deep tracking-[1px]">★★★★★</span> 4,7/5 på <b className="font-display" style={{ color: '#4285F4' }}>G</b>
              </span>
              <span className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-ink bg-surface border border-border py-2 px-3.5 rounded-full" style={{ boxShadow: 'var(--shadow)' }}>
...
export default function HappidentQuizPage() {
  return (
    <Suspense>
      <HappidentQuizPageInner />
    </Suspense>
  )
}
